    ...
    <nav style={{
      ...
      {menuOpen && (
        <div style={{ background: "white", borderTop: "1px solid #eee", padding: "12px 24px 20px" }} className="mobile-menu">
          ...
          <a href="tel:09810077219" style={{ display: "block", marginTop: 12, background: "#e67e22", color: "white", padding: "12px 20px", borderRadius: 8, fontSize: 15, fontWeight: 700, textDecoration: "none", textAlign: "center" }}>
            📞 098100 77219
          </a>
        </div>
      )}
